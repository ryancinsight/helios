...
- [x] Migrate acquisition tests and direct consumers with value-semantic
      assertions across `f32` and `f64`; no complex or imaginary unit applies
      to this real Beer–Lambert contract.
- [x] Update the Helios release/decision artifacts and run focused check,
      Nextest, Clippy, doctest, Rustdoc, and formatting gates. Gap-audit
      insertion remains queued behind the existing peer-owned `gap_audit.md`
      change.
