...
| `helios-imaging` | MVCT acquisition modeling, reconstruction, portal dosimetry, IGRT workflows. Landed (0.0.1): parallel-beam Radon forward transform (`Sinogram`), Ram-Lak FBP reconstruction, and a deterministic quantum-noise model (`add_quantum_noise`, photon statistics). Portal dosimetry + IGRT registration (ritk) pending. | **partial (0.0.1)** |
