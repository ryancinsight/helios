...
| H-032c | `helios-analysis`: local-normalization gamma + low-dose threshold cutoff; RT-struct ROI rasterization → DVH mask (via `ritk`), feeding `from_volume_masked` | [minor] | todo | — | `crates/helios-analysis/**` |
