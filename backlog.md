...
| H-020e | Divergent point-source fan (replace the parallel-beamlet approximation) + lateral scatter kernel (collapsed-cone spread of the terma) + per-leaf collimation via gaia MLC geometry; differential vs the parallel/primary-only reference | [major] | todo | — | `crates/helios-solver/**`, `crates/helios-simulation/**` |
