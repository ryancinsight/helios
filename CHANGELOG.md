...
- H-074: aligned the direct Aequitas and Proteus revisions with the merged
  ...
  Aequitas source identity. CI materializes the complete Proteus/Asclepius
  graph from Atlas `250add4` while the checkout action implementation remains
  pinned to `9bfb722`; the radiation material contract remains unchanged.
